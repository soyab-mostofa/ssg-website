    ...
    <div>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <motion.div 
            className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 perspective-1000"
            drag="x"
            ...
            >
              <AnimatePresence mode="wait">
                <motion.h2
                  ...
                  animate="animate"
                  exit="exit"
                  className="text-grayscale-black text-4xl font-bold md:text-5xl lg:text-6xl relative z-10"
                  style={{
            ...
            >
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  animate="animate"
                  exit="exit"
                  className="text-lg leading-relaxed text-grayscale-black-600 md:text-xl relative z-10 backdrop-blur-sm bg-white/30 p-6 rounded-xl border border-white/20"
                  style={{
          ...
          <AnimatePresence>
            {isDragging && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
              >                <motion.div
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-6xl font-bold"
                  style={{
                    scale: velocityScale,
